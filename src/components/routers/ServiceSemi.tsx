        ...
        <div className="min-h-screen bg-black text-white lg:px-16">
            ...
            <main className="container mx-auto px-4 py-10 ">
                <section className="text-center mb-16">
                    <h1 className="sm:text-4xl text-2xl md:text-5xl font-bold mb-4">Our Services</h1>
                    <p className="sm:text-xl text-lg text-gray-400 max-w-3xl mx-auto">
            ...
            <div className='w-full mt-5 flex items-center justify-center'>
                <Link className=' bg-blue-500 text-white py-3 px-8 rounded-md text-lg font-semibold hover:bg-blue-600 transition duration-300 ' href={"/services"}>View More Services</Link>
            </div>
        </div>
    )
}

export default ServicesSemi
